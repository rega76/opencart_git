...
$_['text_recurring'] = '<p> <i class = "fa fa-info-circle"> </ i> cantidades recurrentes se calculan por la frecuencia y ciclos. </ p> <p> Por ejemplo, si utilizar una frecuencia de "semana" y un ciclo de "2", entonces el usuario ser&aacute; facturado cada 2 semanas. </ p> <p> La duraci&oacute;n es el n&uacute;mero de veces que el usuario va a hacer un pago, ajustar a 0 para hacer pagos hasta que se cancelen. </ p>';
...
$_['entry_trial_duration'] = 'Duraci&oacute;n del Trial';
...
$_['error_name'] = 'El Nombre del Perfil debe contener entre 3 y 255 caracteres.';
$_['error_product'] = 'Este perfil recurrente no puede suprimirse, ya que est&aacute; asignado actualmente a los productos de% s.';